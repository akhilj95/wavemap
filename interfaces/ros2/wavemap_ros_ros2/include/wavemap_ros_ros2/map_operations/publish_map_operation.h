#ifndef WAVEMAP_ROS_ROS2_MAP_OPERATIONS_PUBLISH_MAP_OPERATION_H_
#define WAVEMAP_ROS_ROS2_MAP_OPERATIONS_PUBLISH_MAP_OPERATION_H_
...
class PublishMapOperation : public MapOperationBase {
 ...
 private:
  ...
  // Map publishing
  rclcpp::Publisher<wavemap_msgs_ros2::msg::Map>::SharedPtr map_pub_;
  Timestamp last_run_timestamp_internal_;
  void publishMap(const rclcpp::Time& current_time, bool republish_whole_map);
  ...
  //       transmitting it as a single message would be impractically large.
  template <typename HashedMapT>
  void publishHashedMap(const rclcpp::Time& current_time,
...
#include "wavemap_ros_ros2/map_operations/impl/publish_map_operation_inl.h"

#endif  // WAVEMAP_ROS_ROS2_MAP_OPERATIONS_PUBLISH_MAP_OPERATION_H_
